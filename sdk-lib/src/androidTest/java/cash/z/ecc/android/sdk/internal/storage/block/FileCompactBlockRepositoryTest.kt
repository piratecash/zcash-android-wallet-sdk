...
class FileCompactBlockRepositoryTest {
    ...
    fun writeFewBlocksTest() =
        runTest {
            ...
            val reducedBlocksList =
                ListOfCompactBlocksFixture.newFlow().apply {
    ...
    @Test
    fun writeBlocksAndCheckStorageTest() =
        runTest {
            val rustBackend = FakeRustBackendFixture().new()
    ...
    @Test
    fun deleteCompactBlockFilesTest() =
        runTest {
            val rustBackend = FakeRustBackendFixture().new()
            val blocksDirectory = FilePathFixture.newBlocksDir()
    ...
    fun rewindToTest() =
        runTest {
            ...
            val blocksRangeMiddleValue =
                testedBlocksRange.run {
            ...
            // suppose to be 0
            val keptMetadataAboveRewindHeight =
                rustBackend.metadata
            ...
            val keptMetadataBelowRewindHeight =
                rustBackend.metadata
                    .filter { it.height <= rewindHeight }
